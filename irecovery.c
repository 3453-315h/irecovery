...
int device_limera1n(const char *devicename) {
	...
	if (!strcmp(devicename, "iPhone3,1")) { // iPhone 4 GSM
		max_size = 0x2C000;
		stack_address = 0x8403BF9C;
		shellcode_address = 0x8402B001;
	} else if (!strcmp(devicename, "iPhone3,2")) { // iPhone 4 GSM Rev A
		max_size = 0x2C000;
		stack_address = 0x8403BF9C;
		shellcode_address = 0x8402B001;
	} else if (!strcmp(devicename, "iPhone3,3")) { // iPhone 4 CDMA
		max_size = 0x2C000;
		stack_address = 0x8403BF9C;
		shellcode_address = 0x8402B001;
	} else if (!strcmp(devicename, "iPhone2,1")) { // iPhone 3Gs
		max_size = 0x24000;
		stack_address = 0x84033FA4;
		shellcode_address = 0x84023001;
	} else if (!strcmp(devicename, "iPod3,1")) { // iPod touch (3rd generation)
		max_size = 0x24000;
		stack_address = 0x84033F98;
		shellcode_address = 0x84023001;
	} else if (!strcmp(devicename, "iPod4,1")) { // iPod touch (4th generation)
		max_size = 0x2C000;
		stack_address = 0x8403BF9C;
		shellcode_address = 0x8402B001;
	} else if (!strcmp(devicename, "iPad1,1")) { // iPad (1st generation)
		max_size = 0x2C000;
		stack_address = 0x8403BF9C;
		shellcode_address = 0x8402B001;
	} else {
...
void prog_usage() {
	...
	printf("\t-l <dev>\texploit with limera1n.\n\n");
